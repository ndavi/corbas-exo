 ...
 implements commerces.DistributeurOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("_get_canCrediter", new java.lang.Integer (2));
    _methods.put ("_set_canCrediter", new java.lang.Integer (3));
    _methods.put ("crediter", new java.lang.Integer (4));
    _methods.put ("debiter", new java.lang.Integer (5));
    _methods.put ("infosDistributeur", new java.lang.Integer (6));
  }
